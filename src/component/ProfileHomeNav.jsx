...
function ProfileHome() {
  ...
  const navigateToPage = (pageKey) => {
    ...
    if (pageKey === 'logout') {
      ...
      window.dispatchEvent(new Event('storage')); // login durumu güncelle
    ...
    <Navbar bg="light" expand="lg" className="sticky-top p-0 custom-top-navbar">
      <Container fluid className="p-0" style={{ width: '100%', height: '100%' }}>
        <div className="d-flex align-items-center">
          ...
          >
            <img src={yazi} alt="Logo" width="150" height="auto" className="d-inline-block align-top" />
          </Navbar.Brand>

          <Form className="d-flex custom-search-form" style={{ flexGrow: 1 }} onSubmit={handleSearchSubmit}>
            <FormControl
              type="search"
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-center custom-right-nav">
            ...
            <Nav.Link onClick={() => navigate('/about')} className="custom-nav-link">
              About
            </Nav.Link>
